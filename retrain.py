...
def create_bottlenecks(bottleneck_file, data_dir, base_model, groups_files=[]):
    ...
    if not os.path.exists(bottleneck_file):
        ...
        elif base_model.name == 'inception_resnet_v2':
            preprocess_input = inception_resnet_v2_preprocess_input
        else:
            print(base_model.name, "preprocessing function not found. Using preprocess_input_wrapper()")
